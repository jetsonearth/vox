// CGSSpace.swift - Private API wrapper for window space management
// Original source: https://github.com/avaidyam/Parrot/ (MPL-2.0)
// Adapted from boring.notch

import AppKit

/// Small Spaces API wrapper for positioning windows above all other content.
